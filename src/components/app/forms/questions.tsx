	...
	return (
		...
		>
			...
			<HStack w='full' mt={4} justify='end'>
				...
				<Switch
					checked={watchQuestions[index].mandatory || false}
					onCheckedChange={e => {
						const checked = e.checked

						setValue(`questions.${index}.mandatory`, checked, {
							shouldDirty: true, // Marca o campo como modificado
							shouldValidate: true // Valida o campo após a mudança
						})
					}}
				>
					Obrigatória
